    ...
    class EvaluationVisitor < Visitor
      ...
      def visit_AddNode(o)
        ...
        if left.value.is_a?(::String) || right.value.is_a?(::String)
          Jabl::RKelly::JS::Property.new(:add,
      ...
      def visit_SubtractNode(o)
        Jabl::RKelly::JS::Property.new(:subtract,
      ...
      def visit_MultiplyNode(o)
        ...
        return_val = 
          if [left, right].any? { |x| x.respond_to?(:nan?) && x.nan? }
            Jabl::RKelly::JS::NaN.new
          else
            [left, right].any? { |x|
              x.respond_to?(:intinite?) && x.infinite?
            } && [left, right].any? { |x| x == 0
            } ? Jabl::RKelly::JS::NaN.new : left * right
          end
        Jabl::RKelly::JS::Property.new(:multiple, return_val)
      end
      ...
      def visit_DivideNode(o)
        ...
        Jabl::RKelly::JS::Property.new(:divide, return_val)
      end
      ...
      def visit_NumberNode(o)
        Jabl::RKelly::JS::Property.new(o.value, o.value)
      end

      def visit_VoidNode(o)
        o.value.accept(self)
        Jabl::RKelly::JS::Property.new(:undefined, :undefined)
      end

      def visit_NullNode(o)
        Jabl::RKelly::JS::Property.new(nil, nil)
      end

      def visit_TrueNode(o)
        Jabl::RKelly::JS::Property.new(true, true)
      end

      def visit_FalseNode(o)
        Jabl::RKelly::JS::Property.new(false, false)
      end

      def visit_StringNode(o)
        Jabl::RKelly::JS::Property.new(:string,
          o.value.gsub(/\A['"]/, '').gsub(/['"]$/, '')
        )
      end
      ...
      def visit_EqualNode(o)
        ...
        Jabl::RKelly::JS::Property.new(:equal_node, left.value == right.value)
      end
      ...
      def visit_BitwiseNotNode(o)
        ...
        Jabl::RKelly::JS::Property.new(nil, ~number.value)
      end
      ...
      def visit_TypeOfNode(o)
        ...
        return Jabl::RKelly::JS::Property.new(:string, 'object') if val.value.nil?

        case val.value
        when String
          Jabl::RKelly::JS::Property.new(:string, 'string')
        when Numeric
          Jabl::RKelly::JS::Property.new(:string, 'number')
        when true
          Jabl::RKelly::JS::Property.new(:string, 'boolean')
        when false
          Jabl::RKelly::JS::Property.new(:string, 'boolean')
        when :undefined
          Jabl::RKelly::JS::Property.new(:string, 'undefined')
        else
          Jabl::RKelly::JS::Property.new(:object, 'object')
        end
      end
      ...
      def to_number(object)
        return Jabl::RKelly::JS::Property.new('0', 0) unless object.value
        ...
        return_val =
          ...
          when Jabl::RKelly::JS::Base
            return to_number(to_primitive(object, 'Number'))
          end
        Jabl::RKelly::JS::Property.new(nil, return_val)
      end

      def to_boolean(object)
        return Jabl::RKelly::JS::Property.new(false, false) unless object.value
        value = object.value
        boolean =
          case value
          when :undefined
        ...
        Jabl::RKelly::JS::Property.new(boolean, boolean)
      end
      ...
      def to_int_32(object)
        ...
        if value.respond_to?(:nan?) && (value.nan? || value.infinite?)
          Jabl::RKelly::JS::Property.new(nil, 0)
        end
        value = ((value < 0 ? -1 : 1) * value.abs.floor) % (2 ** 32)
        if value >= 2 ** 31
          Jabl::RKelly::JS::Property.new(nil, value - (2 ** 32))
        else
          Jabl::RKelly::JS::Property.new(nil, value)
        end
      end
      ...
      def to_primitive(object, preferred_type = nil)
        ...
        when false, true, :undefined, ::String, Numeric
          Jabl::RKelly::JS::Property.new(nil, object.value)
        when Jabl::RKelly::JS::Base
