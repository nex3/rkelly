require 'jabl-rkelly/js'
require 'jabl-rkelly/runtime/scope_chain'

module Jabl::RKelly
  class Runtime
    UNDEFINED = Jabl::RKelly::JS::Property.new(:undefined, :undefined)
    ...
    def call_function(function_name, *args)
      ...
      @scope.new_scope { |chain|
        function.js_call(chain, *(args.map { |x|
          Jabl::RKelly::JS::Property.new(:param, x)
        }))
      }.value
    end
